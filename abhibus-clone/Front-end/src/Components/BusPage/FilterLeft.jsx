...
export const FilterLeft = ({filter,seater,buspartnersfn}) => {
  ...
  console.log(matchedBuses.droppingPoint);
	...
	//const [data, setData] = useState(matchedBuses.buses || []);
  ...
  const handlebuspartners = (e,status) => {
    console.log(e.target.value)
    let value=e.target.value
    console.log(status);
    buspartnersfn(value,status)
  }
		...
		<div className={style.filtersBody}>
			...
			<div className={style.BusPartner}>
				...
				>
                    ...
                    onChange={(e) => {
                      ...
                      handlebuspartners(e, e.target.checked);
										}}
										type="checkbox"
                    name="buspartners"
                    value={item.title}
			...
			<div className={style.BusPartner}>
				...
				<div
					...
					className={style.BusPartnerMenu}
				>
					{matchedBuses.droppingPoint?.map((item, i) => {
						return (
							<div>
								<div>
									<input
